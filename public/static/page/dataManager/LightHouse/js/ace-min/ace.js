(function () {
  ...
  define("ace/lib/dom", ["require", "exports", "module"], function (e, t, n) {
    ...
    t.buildDom = function i(e, t, n) {
        ...
        for (var o = l; o < e.length; o++) i(e[o], a, n);
    ...
    var r = e("../lib/event"),
        ...
        c = function (e, t) {
            ...
            var A = !1,
                O = function (e) {
                    L && (e = L(e), L = null),
                    d ? (T(), e && t.onPaste(e), d = !1) : e == c.charAt(0) ? A ? t.execCommand("del", {
                        source: "ace"
                    }) : t.execCommand("backspace", {
                        source: "ace"
                    }) : (e.substring(0, 2) == c ? e = e.substr(2) : e.charAt(0) == c.charAt(0) ? e = e.substr(1) : e.charAt(e.length - 1) == c.charAt(0) && (e = e.slice(0, -1)), e.charAt(e.length - 1) == c.charAt(0) && (e = e.slice(0, -1)), e && t.onTextInput(e)),
                    A && (A = !1)
                },
                M = function (e) {
                    if (v) return;
            ...
            var j = function (e) {
                    ...
                    setTimeout(F, 0),
                    t.on("mousedown", I),
                    v.canUndo && !t.selection.isEmpty() && (t.insert(""), t.session.markUndoGroup(), t.selection.clearSelection()),
                    t.session.markUndoGroup()
                },
                F = function () {
        ...
        (function () {
            ...
            this.getSelections = function (e, t) {
                var n = this.bidiMap,
                    ...
                    c = !1,
                    h = 0;
                for (var p, d = 0; d < i.length; d++) p = n.logicalFromVisual[d],
                s = i[d],
                l = p >= a && p < f,
                l && !c ? h = o : !l && c && u.push({
                        left: h,
        ...
        for (var n = e.length; n--;) {
            ...
            for (var i = r.length; i-- > 0;) {
                var s = r[i],
                    o = v(s, t);
                t = o[0],
                o.length != 2 && (o[2] ? (e.splice(i + 1, 1, o[1], o[2]), i++) : o[1] || (e.splice(i, 1), i--))
            }
        }
        return e
    }
    ...
    var r = e("../range").Range,
        ...
        (function () {
            ...
            this.drawTextMarker = function (t, n, i, s, o) {
                ...
                for (; l <= f; l++) v.start.row = v.end.row = l,
