ace.define("ace/mode/clickhouse_highlight_rules", [ "require", "exports", "$rootScope", "module", "ace/lib/oop", "ace/snippets", 'ace/ext/language_tools' ,"ace/mode/text_highlight_rules"], function (require, exports,$rootScope) {
    "use strict";
    function handleArr(arr,caption=''){
        let arrData=[]
        arr.flat(Infinity).forEach(function(v,i){
            arrData.push(
                    {
                        caption: caption+v,
                        docHTML: true,
    ...
    let ClickhouseHighlightRules = function () {
        ...
        //
        // // ------------------------------------------------------------------------------
        var arr1=handleArr(window.allData[0].data)
        var arr2=[];
        arr2=window.allData[1]&&handleArr(window.allData[1].data,'.')
    ...
    window.ClickhouseHighlightRules=ClickhouseHighlightRules;
    window.inherits=oop.inherits;
    window.TextHighlightRules=TextHighlightRules;
