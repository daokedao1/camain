 ...
 * Copyright (c) 2014-2019 hizzgdev@163.com
 *
 * Project Home:
...
(function($w){
    ...
    jm.prototype={
        ...
        mouseover_handle:function(e){
            ...
            if(nodeid != null){
                jsMind.hiveTableInfo&&jsMind.hiveTableInfo.showDBName(nodeid);
            }
        },
        ...
        click_handle:function(e){
            ...
            if(!!selected_node){
                jsMind.hiveTableConsanguinity&&jsMind.hiveTableConsanguinity.showDBName(nodeid);
            }
        },
