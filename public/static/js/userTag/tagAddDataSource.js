...
require(['jquery','jquery.bootstrap','jquery.datetimepicker','common','quickSearch','app'],function($,d3){
    var tagDataSourceList = {
        ...
        init:function(){
            ...
            if(this.id != null){
                this.getInfo();
                $("#tagType").attr("disabled","disabled");
            }
        },
        ...
        yulanColums:function(){
            ...
            if(verifyFlag){
                ...
                ColumnLabel.dbId = $("#database").attr("data-value");
                ...
                $.ajax({
                    type: "post",
                    url: "/venus/usergroup/label/preview",
                    dataType: "json",
        ...
        saveTag:function(){
            ...
            if(verifyFlag){
               if($("#tagType").val() == 3){
                ...
                ColumnLabel.dbId = $("#database").attr("data-value");
                ColumnLabel.dbName = $("#database").val();
                ...
                var url = "/venus/usergroup/label/create";
                if(this.id != null){
                    url = "/venus/usergroup/label/modify";
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (result && result.success) {
                        ...
                        $("#database").attr("data-value",dat.dbId);
                        $("#database").val(dat.dbName);
                        ...
                        _this.getTable(dat.dbId,$("#tableName"));
                    } else {
