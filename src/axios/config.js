...
// const domain = 'http://47.105.149.158:8080/ca-config-web';
const domain = 'http://39.101.173.52:8088/ca-config-web';
...
export const USER =  domain+'/api/user';//用户
export const USER_DETAIL =  domain+'/api/user/:id';//具体用户
