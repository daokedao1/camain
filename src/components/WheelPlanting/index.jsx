...
import {navBannerList,addNavList,delNavList,editNavList} from '@/axios';
...
class News extends React.Component {
    ...
    async handleOk(){
        ...
        let data={...params};
        if(operationName==='新建'){
            await addNavList(data);
        }else{
            await editNavList(data);
        }
