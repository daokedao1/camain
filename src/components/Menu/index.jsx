...
import {listMenuList,addMenuList,delMenuList,editMenuList} from '@/axios';
        ...
        return (
            <div  className="content">
                <div>
                    <Row >
                        <Col span={24}>
                            <Card title="菜单管理" extra={<Button onClick={()=>this.add('新建')} type="primary">新建</Button>} bordered={false}>
                                <ListTable
                                    loading={loading}
                                    yAxisData={yAxisData}
                                    total={total}
